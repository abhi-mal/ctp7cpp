...
typedef ap_fixed<11,8> conv_t;
typedef ap_ufixed<4,0> conv_weight_t;
typedef ap_ufixed<1,32> conv_bias_t;
typedef ap_ufixed<10,7> conv_relu_t;
typedef ap_fixed<18,8> conv_relu_table_t;
typedef ap_fixed<8,6> dense1_iq_t;
typedef ap_fixed<15,11> dense1_accum_t;
typedef ap_fixed<12,11> dense1_t;
typedef ap_fixed<6,4> dense1_weight_t;
typedef ap_fixed<4,4> dense1_bias_t;
typedef ap_uint<1> layer9_index;
typedef ap_ufixed<11,10> dense1_relu_t;
typedef ap_fixed<18,8> dense1_relu_table_t;
typedef ap_fixed<7,7> dense2_iq_t;
typedef ap_fixed<12,9> dense2_accum_t;
typedef ap_fixed<12,9> dense2_t;
typedef ap_ufixed<5,1> dense2_weight_t;
typedef ap_ufixed<1,32> dense2_bias_t;
typedef ap_uint<1> layer13_index;
typedef ap_ufixed<11,8> result_t;
